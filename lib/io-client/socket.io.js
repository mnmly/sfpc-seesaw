...
return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof browserifyRequire=="function"&&browserifyRequire;if(!u&&a)return a(o,!0);if(i)return i(o,!0);throw new Error("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}var i=typeof browserifyRequire=="function"&&browserifyRequire;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(browserifyRequire,module,exports){

module.exports = browserifyRequire('./lib/');

},{"./lib/":2}],2:[function(browserifyRequire,module,exports){
...
var parser = browserifyRequire('socket.io-parser');
var Manager = browserifyRequire('./manager');
var debug = browserifyRequire('debug')('socket.io-client');
...
exports.Manager = browserifyRequire('./manager');
exports.Socket = browserifyRequire('./socket');

},{"./manager":3,"./socket":5,"./url":6,"debug":9,"socket.io-parser":39}],3:[function(browserifyRequire,module,exports){
...
var url = browserifyRequire('./url');
var eio = browserifyRequire('engine.io-client');
var Socket = browserifyRequire('./socket');
var Emitter = browserifyRequire('emitter');
var parser = browserifyRequire('socket.io-parser');
var on = browserifyRequire('./on');
var bind = browserifyRequire('bind');
var object = browserifyRequire('object-component');
var debug = browserifyRequire('debug')('socket.io-client:manager');
...
},{"./on":4,"./socket":5,"./url":6,"bind":8,"debug":9,"emitter":10,"engine.io-client":11,"object-component":36,"socket.io-parser":39}],4:[function(browserifyRequire,module,exports){
...
var parser = browserifyRequire('socket.io-parser');
var Emitter = browserifyRequire('emitter');
var toArray = browserifyRequire('to-array');
var on = browserifyRequire('./on');
var bind = browserifyRequire('bind');
var debug = browserifyRequire('debug')('socket.io-client:socket');
var hasBin = browserifyRequire('has-binary-data');
...
},{"./on":4,"bind":8,"debug":9,"emitter":10,"has-binary-data":31,"indexof":35,"socket.io-parser":39,"to-array":42}],6:[function(browserifyRequire,module,exports){
var global=typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {};
/**
 * Module dependencies.
 */

var parseuri = browserifyRequire('parseuri');
var debug = browserifyRequire('debug')('socket.io-client:url');
...
},{"debug":9,"parseuri":37}],7:[function(browserifyRequire,module,exports){
/*
 * base64-arraybuffer
...
module.exports = function(obj, fn){
  ...
  if ('function' != typeof fn) throw new Error('bind() browserifyRequires a function');
...
function debug(name) {
  ...
  return function(fmt){
    ...
    // This hackery is browserifyRequired for IE8
...
var index = browserifyRequire('indexof');
...
},{"indexof":35}],11:[function(browserifyRequire,module,exports){

module.exports =  browserifyRequire('./lib/');

},{"./lib/":13}],12:[function(browserifyRequire,module,exports){
...
},{"emitter":10}],13:[function(browserifyRequire,module,exports){

module.exports = browserifyRequire('./socket');
 ...
 *
 */
module.exports.parser = browserifyRequire('engine.io-parser');

},{"./socket":14,"engine.io-parser":24}],14:[function(browserifyRequire,module,exports){
var global=typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {};/**
 * Module dependencies.
 */

var util = browserifyRequire('./util');
var transports = browserifyRequire('./transports');
var Emitter = browserifyRequire('./emitter');
var debug = browserifyRequire('debug')('engine.io-client:socket');
var index = browserifyRequire('indexof');
var parser = browserifyRequire('engine.io-parser');
var parseuri = browserifyRequire('parseuri');
var parsejson = browserifyRequire('parsejson');
...
Socket.Transport = browserifyRequire('./transport');
Socket.Emitter = browserifyRequire('./emitter');
Socket.transports = browserifyRequire('./transports');
Socket.util = browserifyRequire('./util');
Socket.parser = browserifyRequire('engine.io-parser');
...
},{"./emitter":12,"./transport":15,"./transports":17,"./util":22,"debug":9,"engine.io-parser":24,"indexof":35,"parsejson":29,"parseuri":37}],15:[function(browserifyRequire,module,exports){
/**
 * Module dependencies.
 */
...
},{"./emitter":12,"./util":22,"engine.io-parser":24}],16:[function(browserifyRequire,module,exports){
var global=typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {};
/**
 * Module dependencies.
 */

var WS = browserifyRequire('./websocket');
var util = browserifyRequire('../util');
var debug = browserifyRequire('debug')('engine.io-client:flashsocket');
...
},{"../util":22,"./websocket":21,"debug":9}],17:[function(browserifyRequire,module,exports){
var global=typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {};
/**
 * Module dependencies
 */

var XMLHttpRequest = browserifyRequire('xmlhttprequest')
  , XHR = browserifyRequire('./polling-xhr')
  , JSONP = browserifyRequire('./polling-jsonp')
  , websocket = browserifyRequire('./websocket')
  , flashsocket = browserifyRequire('./flashsocket')
...
},{"./flashsocket":16,"./polling-jsonp":18,"./polling-xhr":19,"./websocket":21,"xmlhttprequest":23}],18:[function(browserifyRequire,module,exports){
var global=typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {};
/**
 * Module browserifyRequirements.
 */

var Polling = browserifyRequire('./polling');
var util = browserifyRequire('../util');
...
},{"../util":22,"./polling":20}],19:[function(browserifyRequire,module,exports){
var global=typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {};/**
 * Module browserifyRequirements.
 */
...
var util = browserifyRequire('../util');
var Emitter = browserifyRequire('../emitter');
var debug = browserifyRequire('debug')('engine.io-client:polling-xhr');
...
},{"../emitter":12,"../util":22,"./polling":20,"debug":9,"xmlhttprequest":23}],20:[function(browserifyRequire,module,exports){
var global=typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {};/**
 * Module dependencies.
 */

var Transport = browserifyRequire('../transport');
var util = browserifyRequire('../util');
var parser = browserifyRequire('engine.io-parser');
var debug = browserifyRequire('debug')('engine.io-client:polling');
...
},{"../transport":15,"../util":22,"debug":9,"engine.io-parser":24,"xmlhttprequest":23}],21:[function(browserifyRequire,module,exports){
/**
 * Module dependencies.
 */
...
var parser = browserifyRequire('engine.io-parser');
var util = browserifyRequire('../util');
var debug = browserifyRequire('debug')('engine.io-client:websocket');
...
var WebSocket = browserifyRequire('ws');
...
},{"../transport":15,"../util":22,"debug":9,"engine.io-parser":24,"ws":30}],22:[function(browserifyRequire,module,exports){
var global=typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {};
/**
 * Status of page load.
 */
...
var hasCORS = browserifyRequire('has-cors');
...
},{"has-cors":33}],24:[function(browserifyRequire,module,exports){
var global=typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {};/**
 * Module dependencies.
 */

var keys = browserifyRequire('./keys');
var sliceBuffer = browserifyRequire('arraybuffer.slice');
var base64encoder = browserifyRequire('base64-arraybuffer');
var after = browserifyRequire('after');

/**
 * Check if we are running an android browser. That browserifyRequires us to use
...
var Blob = browserifyRequire('blob');
...
},{"./keys":25,"after":26,"arraybuffer.slice":27,"base64-arraybuffer":7,"blob":28}],25:[function(browserifyRequire,module,exports){
...
},{}],30:[function(browserifyRequire,module,exports){
...
},{"isarray":32}],32:[function(browserifyRequire,module,exports){
...
var global = browserifyRequire('global');
...
},{"global":34}],34:[function(browserifyRequire,module,exports){
...
},{}],38:[function(browserifyRequire,module,exports){
var global=typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {};/**
 * Modle browserifyRequirements
 */
...
},{"isarray":40}],39:[function(browserifyRequire,module,exports){
var global=typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {};
/**
 * Module dependencies.
 */

var debug = browserifyRequire('debug')('socket.io-parser');
var json = browserifyRequire('json3');
var isArray = browserifyRequire('isarray');
var Emitter = browserifyRequire('emitter');
var binary = browserifyRequire('./binary');
...
},{"./binary":38,"debug":9,"emitter":10,"isarray":40,"json3":41}],40:[function(browserifyRequire,module,exports){
module.exports=browserifyRequire(32)
},{}],41:[function(browserifyRequire,module,exports){
        ...
        if (stringifySupported) {
          ...
          try {
            stringifySupported =
              ...
              // The milliseconds are optional in ES 5, but browserifyRequired in 5.1.
          ...
          if (className == dateClass && !isProperty.call(value, "toJSON")) {
            if (value > -1 / 0 && value < 1 / 0) {
              ...
              value = (year <= 0 || year >= 1e4 ? (year < 0 ? "-" : "+") + toPaddedString(6, year < 0 ? -year : year) : toPaddedString(4, year)) +
                ...
                // Milliseconds are optional in ES 5.0, but browserifyRequired in 5.1.
...
},{}],42:[function(browserifyRequire,module,exports){
